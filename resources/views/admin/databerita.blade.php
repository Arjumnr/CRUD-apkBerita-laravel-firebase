  ...
  <body class="skin-blue">
    <div class="wrapper">
            ...
            <div class="col-md-12">
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title"><a href="/berita/tambah-berita" class="btn btn-success mx-5" style="margin-left:10px ">Tambah +</a></h3>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2021-2022 <a href="http://berita.com">Berita</a>.</strong> All rights.
      </footer>
    </div><!-- ./wrapper -->

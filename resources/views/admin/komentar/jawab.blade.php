                        ...
                        <form role="form" action="/berita/update/{{ $data->id }} " method="post">
                          ...
                          <div class="box-body">
                            <div class="form-group">
                              ...
                              <input type="text" value="{{ $data->email }}" name= "judul" class="form-control" id="exampleInputEmail1" placeholder="Masukan Judul">
                            </div>
                            <div class="form-group">
                              <label for="exampleInputPassword1">komentar</label>
                              <textarea name="komentar" id="summernote">{{ $data->komentar }}</textarea>
                              
                            </div>
                            <div class="form-group">
                              <label for="exampleInputPassword1">Tanggal di Edit</label>

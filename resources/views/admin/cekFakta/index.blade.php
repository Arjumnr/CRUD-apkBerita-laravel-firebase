                    ...
                    <table class="table table-hover table-striped">
                      <thead>
                        <tr>
                          ...
                          <th scope="col">Tangal di Buat</th>
                                     ...
                                     <button  type="button" class="btn btn-danger"  data-toggle="modal" data-target="#exampleModalLong">Cek Berita  </button>
                                      ...
                                      <div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            ...
                                            <form action="{{ route('keterangan',''.$row->id.'') }}" method="POST">
                                              @csrf
                                                  <div class="modal-footer">
                                                    <button type="submit" name="keterangan" value="Fakta" class="btn btn-warning">Tidak</button>
                                                    <button type="submit" name="keterangan" value="Hoax"  class="btn btn-primary">Ya</button>
                                                  </div>
                                            </form>
                                            </div>
                                        </div>
